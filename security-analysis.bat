@echo off
REM ==========================================================================
REM System Information Collection Script for Security Analysis
...
REM -- Local Accounts and Security --
...
echo %OutputFile%
echo The security policy export is in SecPol.cfg (if successful).
echo.
echo Manual Analysis Required! This report is a working base.
echo Done.
pause
